# Frontend Lab - Notes App

![Design preview for the Notes App frontend assessment](./preview.png)
...
Your challenge is to build a Notes App using React.
...
- Allow users to edit the title and description of existing notes
- Store notes locally in the browser using localStorage
- Ensure data persistence so that notes are preserved even if the user refreshes the page or closes the browser
- Implement search functionality to allow users to find notes by title
